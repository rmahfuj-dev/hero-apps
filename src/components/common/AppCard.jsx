...
const AppCard = ({ id, image, title, downloads, ratingAvg }) => {
  ...
  return (
    <div
      className="flex flex-col w-full max-w-[348px] h-[435px] items-center rounded-xl p-4 bg-white gap-4 justify-between hover:translate-y-[-8px] duration-300 transition-all shadow-md"
      onClick={() => {
        navigate(`/apps/${id}`);
      }}
    >
